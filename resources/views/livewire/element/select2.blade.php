    ...
    <div @click.outside="isOpen = false">
        <div @click.prevent="isOpen = ! isOpen">
            <div
                ...
                @if (!empty($name))
                    <button wire:click.prevent="clear" type="button"
                        class="relative z-10 w-5 h-5 text-slate-300 hover:text-slate-700">
            ...
            <button type="button"
                ...
                <svg class="w-5 h-5 text-slate-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
        ...
        <div x-show="isOpen" x-trap="isOpen" x-cloak x-transition:enter="transition ease-out duration-100 transform"
            ...
            class="absolute z-20 w-full mt-2 overflow-auto text-base rounded-md shadow-lg bg-slate-200 max-h-56 ring-1 ring-black/5 focus:outline-none sm:text-sm"
