<div class="relative w-full" x-data="{ show: false }">
    <x:component::icon.lock class="absolute text-slate-400 material-symbols-outlined left-2 top-1/4" />
    ...
    <button type="button" @click.prevent="show = ! show"
        class="absolute flex items-center justify-center text-slate-400 material-symbols-outlined right-2 top-1/4">
